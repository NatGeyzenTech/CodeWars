...
// SOLUTION 1A: Pushing numbers except smallest into a new array
...
// SOLUTION 2A: Filtering out the smallest number by index
function removeSmallest(numbers) {
  const smallestIndex = numbers.indexOf(Math.min(...numbers));
...
// SOLUTION 3A: Slicing out the smallest number by index
function removeSmallest(numbers) {
  const smallestIndex = numbers.indexOf(Math.min(...numbers));
