...
// SOLUTION 1A: If/else statements with Number.isInteger()
...
// SOLUTION 2A: Returning conditional with Number.isInteger() 
function checkForFactor (base, factor) {
    return Number.isInteger(base / factor);
}

// SOLUTION 2B: ES6 arrow function alternative
const checkForFactor = (base, factor) => Number.isInteger(base / factor);

// SOLUTION 3A: Returning conditional with modulo operator
function checkForFactor (base, factor) {
